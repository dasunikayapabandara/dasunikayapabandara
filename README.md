...
Feel free to explore my repositories and reach out with any questions or collaboration ideas. Happy coding! 🚀
  ...
  <svg
    ...
    .stat {
      font: 600 14px 'Segoe UI', Ubuntu, "Helvetica Neue", Sans-Serif; fill: #878787;
    }
    @supports(-moz-appearance: auto) {
      /* Selector detects Firefox */
      .stat { font-size:12px; }
    ...
    .rank-text {
      font: 800 24px 'Segoe UI', Ubuntu, Sans-Serif; fill: #878787;
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 230.2311552991578;
      }
    }
